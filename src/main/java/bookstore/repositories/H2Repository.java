...
/**
 * H2Repository: A database-backed, transient implementation of IRepository.
 * Delegates storage, query execution, and transactions to an in-memory H2 SQL instance [7].
 */
public class H2Repository implements IRepository<ProductEntity> {
    ...
    public H2Repository() {
        // Loads the specific H2 in-memory persistence unit from persistence.xml [7]
    ...
    public ProductEntity save(ProductEntity entity) {
        ...
        try {
            tx.begin();
            // Upsert strategy: Persist if new, merge if record already exists in H2 [7]
    ...
    public void close() {
        ...
        System.out.println("Transient H2 connections closed cleanly.");
    }
}